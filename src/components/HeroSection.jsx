...
export default function HeroSection({ onBookClick }) {
  return (
    <section
      id="hero"
      className="relative w-full pt-14 sm:pt-16 pb-0 bg-[#2D0A22] overflow-hidden flex flex-col items-center justify-center"
    >
      {/* Banner 1: RJ MIT Spotlight Hero Banner - Full Width Edge-to-Edge */}
      ...
      {/* Banner 2: Atrangi Band Royal Navratri Garba Festival Banner - Full Width Edge-to-Edge */}
      <div className="relative w-full p-0 m-0 leading-none">
        <img
